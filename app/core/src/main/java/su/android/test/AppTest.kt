...
class AppTest : BaseTest {
    ...
    fun testRequest() {
        ...
        // Make sure RequestActivity is launched
        val suRequest = monitor.waitForActivityWithTimeout(TimeUnit.SECONDS.toMillis(10))
        assertNotNull("RequestActivity is not launched", suRequest)
        ...
        runBlocking {
            ...
            assertEquals("Policy for shell is incorrect", Policy.ALLOW, policy.policy)
        }
    }
}
