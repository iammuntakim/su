...
import android.sum.extensions.getProperty
...
val isRunningAsStub get() = DeviceInfo.stub != null

object DeviceInfo {

    var stub: StubPackageManager.Data? = null
    ...
    class Env(
        ...
        val versionCode = when {
            code < AppConstants.Version.MIN_VERCODE -> -1
            isRooted -> code
            else -> -1
        }
        val isUnsupported = code > 0 && code < AppConstants.Version.MIN_VERCODE
