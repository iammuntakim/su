package android.sum.download

import android.net.Uri
import android.sum.StubApk
import android.sum.R
import android.sum.isRunningAsStub
import android.sum.ktx.cachedFile
import android.sum.ktx.copyAll
import android.sum.ktx.copyAndClose
import android.sum.ktx.withInOut
import android.sum.ktx.writeTo
import android.sum.tasks.AppMigration
import android.sum.utils.MediaStoreUtils.outputStream
import android.sum.utils.APKInstall
