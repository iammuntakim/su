package android.sum.di

import android.annotation.SuppressLint
import android.content.Context
import android.text.method.LinkMovementMethod
import androidx.room.Room
import android.sum.AppContext
import android.sum.Const
import android.sum.data.LogDatabase
import android.sum.data.policy.PolicyDao
import android.sum.data.policy.SettingsDao
import android.sum.data.policy.StringDao
import android.sum.ktx.deviceProtectedContext
import android.sum.repository.LogRepository
import android.sum.repository.NetworkService
