...
import android.sum.StubApk
import android.sum.AppApkPath
import android.sum.BuildConfig
import android.sum.Config
import android.sum.Const
import android.sum.Info
import android.sum.di.ServiceLocator
import android.sum.isRunningAsStub
import android.sum.ktx.copyAll
import android.sum.ktx.writeTo
import android.sum.utils.DummyList
import android.sum.utils.MediaStoreUtils
import android.sum.utils.MediaStoreUtils.inputStream
import android.sum.utils.MediaStoreUtils.outputStream
import android.sum.utils.RootUtils
...
abstract class InstallImpl protected constructor(
...
abstract class CallBackInstaller : InstallImpl(DummyList, DummyList) {
