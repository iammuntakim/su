...
import android.sum.BuildConfig.APP_VERSION_CODE
...
object AppConstants {
    ...
    const val DAEMON_LOG = "/cache/magisk.log"
    ...
    object Version {
        ...
        private fun isCanary() = (DeviceInfo.env.versionCode % 100) != 0
        fun atLeast_24_0() = DeviceInfo.env.versionCode >= 24000 || isCanary()
        fun atLeast_25_0() = DeviceInfo.env.versionCode >= 25000 || isCanary()
        fun atLeast_28_0() = DeviceInfo.env.versionCode >= 28000 || isCanary()
        fun atLeast_30_1() = DeviceInfo.env.versionCode >= 30100 || isCanary()
    }
    ...
    object Url {
        ...
        const val SOURCE_CODE_URL = "https://github.com/iammuntakim/su"
