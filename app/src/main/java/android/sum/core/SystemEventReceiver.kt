...
import android.sum.foundation.BaseReceiver
...
import android.sum.notification.ShortcutHelper
...
open class SystemEventReceiver : BaseReceiver() {
    ...
    override fun onReceive(context: Context, intent: Intent?) {
        ...
        when (intent.action ?: return) {
            ...
            Intent.ACTION_LOCALE_CHANGED -> ShortcutHelper.setupDynamic(context)
