...
import android.sum.download.DownloadEngine
import android.sum.download.Subject
import android.sum.ktx.getBitmap
import android.sum.ktx.selfLaunchIntent
        ...
        AppContext.apply {
            ...
            val builder = if (SDK_INT >= Build.VERSION_CODES.O) {
                Notification.Builder(this, UPDATED_CHANNEL)
                    .setSmallIcon(getBitmap(R.drawable.ic_app_logo_outline).toIcon())
            } else {
                Notification.Builder(this).setPriority(Notification.PRIORITY_HIGH)
                    .setSmallIcon(R.drawable.ic_app_logo_outline)
            }
    ...
    fun updateAvailable() {
        AppContext.apply {
            ...
            val builder = if (SDK_INT >= Build.VERSION_CODES.O) {
                ...
                .setLargeIcon(bitmap)
                .setContentTitle(getString(R.string.manager_update_title))
