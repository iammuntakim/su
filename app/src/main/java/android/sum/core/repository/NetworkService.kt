package android.sum.repository

import android.sum.BuildConfig
import android.sum.Config
import android.sum.Config.Value.BETA_CHANNEL
import android.sum.Config.Value.CUSTOM_CHANNEL
import android.sum.Config.Value.DEBUG_CHANNEL
import android.sum.Config.Value.DEFAULT_CHANNEL
import android.sum.Config.Value.STABLE_CHANNEL
import android.sum.Info
import android.sum.data.GithubApiServices
import android.sum.data.RawUrl
import android.sum.ktx.dateFormat
import android.sum.model.Release
import android.sum.model.ReleaseAssets
import android.sum.model.UpdateInfo
...
class NetworkService(
    ...
    private suspend fun fetchCustomUpdate(url: String): UpdateInfo {
        val info = raw.fetchUpdateJson(url).manager
