...
data class LocalModule(
    ...
    companion object {
        ...
        fun loaded() = RootUtils.fs.getFile(AppConstants.MODULE_PATH).exists()

        suspend fun installed() = withContext(Dispatchers.IO) {
            RootUtils.fs.getFile(AppConstants.MODULE_PATH)
                .listFiles()
                .orEmpty()
