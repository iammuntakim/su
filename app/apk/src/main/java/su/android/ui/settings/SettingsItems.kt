...
object DoHToggle : BaseSettingsItem.Toggle() {
    override val icon = R.drawable.ic_dns_md2
...
object SystemlessHosts : BaseSettingsItem.Blank() {
    override val icon = R.drawable.ic_module_storage_md2
...
object Zygisk : BaseSettingsItem.Toggle() {
    override val icon = R.drawable.ic_zygisk_md2
...
object DenyList : BaseSettingsItem.Toggle() {
    override val icon = R.drawable.ic_restrict_md2
...
object DenyListConfig : BaseSettingsItem.Blank() {
    override val icon = R.drawable.ic_settings_md2
...
object Tapjack : BaseSettingsItem.Toggle() {
    override val icon = R.drawable.ic_action_md2
...
object Authentication : BaseSettingsItem.Toggle() {
    override val icon = R.drawable.ic_authenication_md2
...
object AccessMode : BaseSettingsItem.Selector() {
    override val icon = R.drawable.ic_superuser_md2
...
object MultiuserMode : BaseSettingsItem.Selector() {
    override val icon = R.drawable.ic_superuser_outlined_md2
...
object MountNamespaceMode : BaseSettingsItem.Selector() {
    override val icon = R.drawable.ic_folder_list
...
object AutomaticResponse : BaseSettingsItem.Selector() {
    override val icon = R.drawable.ic_check_circle_md2
...
object RequestTimeout : BaseSettingsItem.Selector() {
    override val icon = R.drawable.ic_timer_md2
...
object SUNotification : BaseSettingsItem.Selector() {
    override val icon = R.drawable.ic_notifications_md2
...
object Reauthenticate : BaseSettingsItem.Toggle() {
    override val icon = R.drawable.ic_restart
...
object Uninstall : BaseSettingsItem.Blank() {
    override val icon = R.drawable.ic_delete_md2
