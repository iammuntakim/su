...
object DownloadPath : BaseSettingsItem.Input() {
    override val icon: Int? = R.drawable.Download
    override var value
...
object DoHToggle : BaseSettingsItem.Toggle() {
    override val icon: Int? = R.drawable.Dns
...
object SystemlessHosts : BaseSettingsItem.Blank() {
    override val icon: Int? = R.drawable.ModuleStorage
...
object Zygisk : BaseSettingsItem.Toggle() {
    override val icon: Int? = R.drawable.Zygisk
...
object DenyList : BaseSettingsItem.Toggle() {
    override val icon: Int? = R.drawable.Restrict
...
object Tapjack : BaseSettingsItem.Toggle() {
    override val icon: Int? = R.drawable.Action
...
object Authentication : BaseSettingsItem.Toggle() {
    override val icon: Int? = R.drawable.Authentication
...
object AccessMode : BaseSettingsItem.Selector() {
    override val icon: Int? = R.drawable.Superuser
...
object MultiuserMode : BaseSettingsItem.Selector() {
    override val icon: Int? = R.drawable.SuperuserOutlined
...
object MountNamespaceMode : BaseSettingsItem.Selector() {
    override val icon: Int? = R.drawable.FolderList
...
object AutomaticResponse : BaseSettingsItem.Selector() {
    override val icon: Int? = R.drawable.CheckCircle
...
object SUNotification : BaseSettingsItem.Selector() {
    override val icon: Int? = R.drawable.Notifications
...
object Reauthenticate : BaseSettingsItem.Toggle() {
    override val icon: Int? = R.drawable.Restart
...
object Uninstall : BaseSettingsItem.Blank() {
    override val icon: Int? = R.drawable.Delete
